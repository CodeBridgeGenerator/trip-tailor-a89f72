...
import SingleInterestsPage from "../components/app_components/InterestsPage/SingleInterestsPage";
import InterestProjectLayoutPage from "../components/app_components/InterestsPage/InterestProjectLayoutPage";
import SingleUserInterestsPage from "../components/app_components/UserInterestsPage/SingleUserInterestsPage";
import UserInterestProjectLayoutPage from "../components/app_components/UserInterestsPage/UserInterestProjectLayoutPage";
...
<Route path="/interests/:singleInterestsId" exact element={<SingleInterestsPage />} />
<Route path="/interests" exact element={<InterestProjectLayoutPage />} />
<Route path="/userInterests/:singleUserInterestsId" exact element={<SingleUserInterestsPage />} />
<Route path="/userInterests" exact element={<UserInterestProjectLayoutPage />} />
