...
summary: _entity?.summary,
    ...
    return (
        <Dialog header="Edit Day Plans" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputTextarea id="summary" rows={5} cols={30} value={_entity?.summary} onChange={ (e) => setValByKey("summary", e.target.value)} autoResize  required  />
            </span>
            <small className="p-error">
