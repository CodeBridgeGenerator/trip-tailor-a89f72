...
const inputTextareaTemplate1 = (rowData, { rowIndex }) => <p >{rowData.title}</p>
...
const calendar_12Template8 = (rowData, { rowIndex }) => <p>{new Date(rowData.createdAt).toLocaleDateString()}</p>
...
<Column field="title" header="Title" body={inputTextareaTemplate1} filter={selectedFilterFields.includes("title")} hidden={selectedHideFields?.includes("title")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="groupSize" header="Group Size" body={p_numberTemplate4} filter={selectedFilterFields.includes("groupSize")} hidden={selectedHideFields?.includes("groupSize")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="createdAt" header="Created At" body={calendar_12Template8} filter={selectedFilterFields.includes("createdAt")} hidden={selectedHideFields?.includes("createdAt")}  sortable style={{ minWidth: "8rem" }} />
