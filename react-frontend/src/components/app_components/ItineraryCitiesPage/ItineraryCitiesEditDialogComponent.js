...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="longitude" className="w-full mb-3 p-inputtext-sm" value={_entity?.longitude} onChange={(e) => setValByKey("longitude", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="latitude" className="w-full mb-3 p-inputtext-sm" value={_entity?.latitude} onChange={(e) => setValByKey("latitude", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
